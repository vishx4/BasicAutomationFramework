...
public class FailedCreditCardPaymentTest extends base{
	...
	public void  failedPaymentFlow() throws IOException, InterruptedException {
		...
		pdp.cardNumber().sendKeys(prop.getProperty("wrong"));
		...
		Thread.sleep(2000);
		Assert.assertTrue(pdp.failedPayment().isDisplayed());
		log.trace("Payment Failed Due to  Wrong Credit Card Details");
